...
const TESTIMONIALS_DATA = {
  fr: [
    { name: 'Sophie Laurent', role: 'CEO, InnovateTech', avatar: 'SL', rating: 5, content: "Faucar a transformé notre vision complexe en une application intuitive et ultra-rapide. Son expertise technique et ses conseils ont été inestimables pour le succès de notre lancement." },
    { name: 'Marc Dubois', role: 'Directeur Marketing, RetailCorp', avatar: 'MD', rating: 5, content: "Un développeur exceptionnel qui comprend non seulement le code, mais aussi les enjeux business. Notre taux de conversion a augmenté de 40% après la refonte de notre plateforme." },
    { name: 'Amélie Rousseau', role: 'Fondatrice, Startup locale', avatar: 'AR', rating: 4, content: "Professionnel, réactif et créatif. Il a su respecter des délais très serrés sans jamais compromettre la qualité finale. Je le recommande vivement." },
    { name: 'Thomas Bernard', role: 'CTO, DataSystems', avatar: 'TB', rating: 5, content: "Son architecture backend est propre et facilement maintenable. C'est rare de trouver un freelance avec un tel niveau d'exigence sur la qualité du code." },
    { name: 'Julie Leroy', role: 'Gérante, Restaurant L\'Épicure', avatar: 'JL', rating: 5, content: "Notre nouveau site web est magnifique. Nos clients n'arrêtent pas de nous faire des compliments sur le système de réservation." },
  ],
  en: [
    { name: 'Sophie Laurent', role: 'CEO, InnovateTech', avatar: 'SL', rating: 5, content: "Faucar transformed our complex vision into an intuitive, ultra-fast application. His technical expertise and advice were invaluable for our successful launch." },
    { name: 'Marc Dubois', role: 'Marketing Director, RetailCorp', avatar: 'MD', rating: 5, content: "An exceptional developer who understands not only code, but also business challenges. Our conversion rate increased by 40% after he redesigned our platform." },
    { name: 'Amélie Rousseau', role: 'Founder, Local Startup', avatar: 'AR', rating: 4, content: "Professional, responsive and creative. He met very tight deadlines without ever compromising the final quality. I highly recommend him." },
    { name: 'Thomas Bernard', role: 'CTO, DataSystems', avatar: 'TB', rating: 5, content: "His backend architecture is clean and easily maintainable. It's rare to find a freelancer with such a high standard for code quality." },
    { name: 'Julie Leroy', role: 'Manager, Restaurant L\'Épicure', avatar: 'JL', rating: 5, content: "Our new website is beautiful. Our customers won't stop complimenting us on the reservation system." },
  ],
  es: [
    { name: 'Sophie Laurent', role: 'CEO, InnovateTech', avatar: 'SL', rating: 5, content: "Faucar transformó nuestra visión compleja en una aplicación intuitiva y ultrarrápida. Su experiencia técnica y sus consejos fueron invaluables para el éxito de nuestro lanzamiento." },
    { name: 'Marc Dubois', role: 'Director de Marketing, RetailCorp', avatar: 'MD', rating: 5, content: "Un desarrollador excepcional que entiende no solo el código, sino también los desafíos empresariales. Nuestra tasa de conversión aumentó un 40% tras la renovación de nuestra plataforma." },
    { name: 'Amélie Rousseau', role: 'Fundadora, Startup local', avatar: 'AR', rating: 4, content: "Profesional, reactivo y creativo. Cumplió plazos muy ajustados sin comprometer nunca la calidad final. Lo recomiendo ampliamente." },
    { name: 'Thomas Bernard', role: 'CTO, DataSystems', avatar: 'TB', rating: 5, content: "Su arquitectura backend es limpia y fácilmente mantenible. Es raro encontrar un freelance con tan alto nivel de exigencia en la calidad del código." },
    { name: 'Julie Leroy', role: 'Gerente, Restaurant L\'Épicure', avatar: 'JL', rating: 5, content: "Nuestro nuevo sitio web es hermoso. Nuestros clientes no paran de hacernos cumplidos sobre el sistema de reservas." },
  ],
};
...
const translations = {
  fr: {
    ...
    contact: {
      ...
      formName: 'Nom complet', formEmail: 'Adresse email', formSubject: 'Sujet', formMessage: 'Message',
      formNamePH: 'Jean Dupont', formSubjectPH: 'Refonte de site web...', formMsgPH: 'Décrivez votre projet en quelques mots...',
  ...
  en: {
    ...
    contact: {
      ...
      formName: 'Full name', formEmail: 'Email address', formSubject: 'Subject', formMessage: 'Message',
      formNamePH: 'John Doe', formSubjectPH: 'Website redesign...', formMsgPH: 'Describe your project in a few words...',
  ...
  es: {
    ...
    contact: {
      ...
      formName: 'Nombre completo', formEmail: 'Correo electrónico', formSubject: 'Asunto', formMessage: 'Mensaje',
      formNamePH: 'Juan García', formSubjectPH: 'Rediseño de sitio web...', formMsgPH: 'Describa su proyecto en pocas palabras...',
